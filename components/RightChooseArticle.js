...
const RightChooseArticle = () => {
  return (
    <article className="flex flex-col items-center justify-center pl-4 sm:pl-16 gap-y-12">
      ...
      <div className="flex flex-col items-center justify-center">
        <GlassSvg className="w-10 h-10 lg:w-20 lg:h-20" />
      ...
      <div className="flex flex-col items-center justify-center">
        <ThreePersonSvg className="w-10 h-10 lg:w-20 lg:h-20" />
        <p className="text-gray-500 text-sm lg:text-base lg:w-[30ch] text-center mt-5">
          Results can only be shared by siblings with the same two parents
        </p>
      </div>
      <div className="flex flex-col items-center justify-center">
        <InternetSvg className="w-10 h-10 lg:w-20 lg:h-20" />
        <p className="text-gray-500 text-sm lg:text-base lg:w-[30ch] text-center mt-5">
          Contain fewer than 3000 African lineages across 10 African regions
        </p>
      </div>
      <div className="flex flex-col items-center justify-center">
        <DisLikeSvg className="w-10 h-10 lg:w-20 lg:h-20" />
        <p className="text-gray-500 text-sm lg:text-base lg:w-[30ch] text-center mt-5">
