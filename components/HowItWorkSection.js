    ...
    <section className="bg-white">
      <div className="flex flex-col items-center justify-center max-w-lg px-4 pt-20 pb-20 m-auto bg-white lg:max-w-7xl">
        ...
        <p className="mt-5 tracking-widest text-purple-secondary lg:w-[100ch] text-center">
          We each carry in our DNA a series of indicators that provide
          information about our ancestry. This information is passed from
          generation to generation and can tell a profound story about where we
          come from, and highlight our connections to modern-day Africa.
        </p>
